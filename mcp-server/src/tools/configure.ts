...
export interface ConfigureInput {
  projectPath?: string;
  /** Per-machine toggle (local, gitignored auto-capture.json). */
  autoCapture?: boolean;
  /** Per-team toggle (committed index.json) for whether patches/ is committed. */
 ...
 */
export async function configure(input: ConfigureInput): Promise<string> {
