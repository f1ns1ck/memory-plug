    ...
    inputSchema: {
      ...
      properties: {
        ...
        enrichChangeId: {
          type: "string",
          description:
            "Enrich an existing record instead of capturing: apply llmSummary (required) plus optional llmRisk/llmType/tags to this change id in place — same id, patch and timestamp — and mark it enriched. Use for records listed under 'Awaiting Enrichment' in the session snapshot.",
        },
      },
    },
    ...
    inputSchema: {
      ...
      properties: {
        ...
        autoCapture: {
          type: "boolean",
          description:
            "true to enable automatic capture on this machine, false to disable. Omit to leave unchanged.",
        },
        sharePatches: {
          type: "boolean",
          description:
            "true to commit patches/ for the team, false to keep them machine-local. Omit to leave unchanged.",
        },
      },
    },
    handler: (a: any) => configure(a ?? {}),
  },
  {
